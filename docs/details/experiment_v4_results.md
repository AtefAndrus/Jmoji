...
**最良結果**: v4_top100（Jaccard 0.120、目標達成）、v4_focal_top100（多様性25%、最良）
...
| 課題 | 詳細 | 対策案 |
|------|------|--------|
| 多様性不足 | 25%（目標30%） | top50でデータ密度向上 |
| soft mode collapse | 😊📚🔥の過剰生成 | データ密度のさらなる向上 |
| Exact Match 0% | 完全一致なし | top50で件/絵文字84件に |
...
| アクション | 理由 | 期待効果 |
|-----------|------|----------|
| **v4_top50** | 件/絵文字 84件に向上 | Jaccard 0.15+、多様性30%+ |
| v4_focal_top50 | top50 + Focal Loss | 多様性のさらなる改善 |
...
| データ生成時のtop50/100優先 | フィルタ率向上 | より多くの学習データ |
