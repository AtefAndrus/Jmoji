# 進捗チェックリスト（更新: 2025-12-25 v4_top50完了、Jaccard 0.165達成）
...
- [x] **v4データセット学習実験** → 完了、詳細は [実験結果](details/experiment_v4_results.md)
  ...
  - [x] v4_top50: top50フィルタ適用 → **Jaccard 0.165（+38%、精度最良）**、多様性21%
...
- [x] **v4_top50の検証** → **完了**（2025-12-25）、Jaccard 0.165達成（精度最良）
- [ ] **v4_focal_top50の検証** — top50 + Focal LossでJaccard維持 + 多様性改善を期待
